export const configurations = {
    ...
    app: {
        categories: [
            {
                name: 'Bees',
                coverPicture: 'src/assets/images/categories/bees.png',
                facts: [
            ...
            {
                name: 'Beetles',
                coverPicture: 'path/to/beetles_cover_picture.jpg',
                facts: [
            ...
            {
                name: 'Butterflies',
                coverPicture: 'path/to/butterflies_cover_picture.jpg',
                facts: [
            ...
            {
                name: 'Cicadas',
                coverPicture: 'path/to/cicadas_cover_picture.jpg',
                facts: [
            ...
            {
                name: 'Dragonflies',
                coverPicture: 'path/to/dragonflies_cover_picture.jpg',
                facts: [
            ...
            {
                name: 'Grasshopper',
                coverPicture: 'path/to/grasshopper_cover_picture.jpg',
                facts: [
            ...
            {
                name: 'Moth',
                coverPicture: 'path/to/moth_cover_picture.jpg',
                facts: [
            ...
            {
                name: 'Scorpion',
                coverPicture: 'path/to/scorpion_cover_picture.jpg',
                facts: [
            ...
            {
                name: 'Snail',
                coverPicture: 'path/to/snail_cover_picture.jpg',
                facts: [
            ...
            {
                name: 'Spider',
                coverPicture: 'path/to/spider_cover_picture.jpg',
                facts: [
